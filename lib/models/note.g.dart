...
int _noteEstimateSize(
  ...
  bytesCount += 3 + object.noteDescr.length * 3;
...
void _noteSerialize(
  ...
  writer.writeString(offsets[0], object.noteDescr);
...
Note _noteDeserialize(
  ...
  final object = Note();
  object.id = id;
  object.noteDescr = reader.readString(offsets[0]);
...
extension NoteQueryFilter on QueryBuilder<Note, Note, QFilterCondition> {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> noteDescrEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'noteDescr',
        value: value,
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> noteDescrGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> noteDescrLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> noteDescrBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> noteDescrStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> noteDescrEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> noteDescrContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> noteDescrMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> noteDescrIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'noteDescr',
        value: '',
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> noteDescrIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'noteDescr',
        value: '',
...
extension NoteQuerySortBy on QueryBuilder<Note, Note, QSortBy> {
  QueryBuilder<Note, Note, QAfterSortBy> sortByNoteDescr() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'noteDescr', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> sortByNoteDescrDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'noteDescr', Sort.desc);
    });
  }
...
extension NoteQuerySortThenBy on QueryBuilder<Note, Note, QSortThenBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> thenByNoteDescr() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'noteDescr', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> thenByNoteDescrDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'noteDescr', Sort.desc);
    });
  }
...
extension NoteQueryWhereDistinct on QueryBuilder<Note, Note, QDistinct> {
  QueryBuilder<Note, Note, QDistinct> distinctByNoteDescr(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'noteDescr', caseSensitive: caseSensitive);
    });
  }
...
extension NoteQueryProperty on QueryBuilder<Note, Note, QQueryProperty> {
  ...
  QueryBuilder<Note, String, QQueryOperations> noteDescrProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'noteDescr');
    });
  }
